      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1">
            <span className="text-sm font-semibold bg-primary/10 px-3 py-1 rounded-full text-primary inline-block mb-6">Our Mission</span>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 font-space">Building AI-powered connections in your community</h2>
            ...
            <div className="flex flex-wrap gap-4">
              <Button asChild className="rounded-full bg-primary hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/20 transition-all">
                <Link to="/about" className="flex items-center">
                  Learn More
                </Link>
              </Button>
              <Button variant="outline" asChild className="rounded-full bg-transparent border-white/10 hover:bg-primary/10 hover:border-primary/50">
          ...
          <div className="order-1 md:order-2">
            <div className="glass-card rounded-xl backdrop-blur-lg border border-white/10 shadow-lg p-8">
              <div className="flex items-center mb-6">
                <Bot className="h-6 w-6 text-primary mr-2" />
                <h3 className="font-bold text-xl font-space gradient-text">Migo Impact</h3>
              </div>
              <div className="grid grid-cols-2 gap-6">
                <div className="glass-card bg-background/40 rounded-lg p-4 transition-all duration-300 hover:shadow-primary/20 hover:border-primary/20">
